...
import wiringtable from './../../img/WiringHarness/wiring-table.jpg';


export class WiringHarness extends Component {
    render() {
        return ( <
            ProjectPage title = "Wiring Harness Model and Routing"
            images = {
                [{
                        image: wiringharness,
